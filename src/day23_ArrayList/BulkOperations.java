...
public class BulkOperations {
    public static void main(String[] args) {
       ...
       // l1.addAll(Arrays.asList(nums));
        ...
        list.removeAll(Arrays.asList(10,20)); //size of arraylist will decrease
        System.out.println(list);
        
        ArrayList<String> developers = new ArrayList<>();
        developers.addAll(Arrays.asList("Alena","Muhtar", "Gadir", "Ali","Khashavar", "Madiyar", "Muhtar", "Muhtar","Alena"));
