...
public class Pizza {
    //multiple copies of variable is needed. instance class is created within class.
    public char size; //it means they can have different size, when you change one object it wont change other objects
