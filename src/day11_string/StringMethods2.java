...
public class StringMethods2 {
    public static void main(String[] args) {
        String sentence = "I love Python, Python is best programming language ";
        ...
        sentence= sentence2.replaceFirst("Java", "Python");
        ...
        //--------
        String email = "CydeoSchoolJavaProgrammming@gmail.com";
