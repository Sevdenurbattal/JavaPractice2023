...
so, there are 3 outputs, it is better to use boolean variable so that you can reuse it

?? FOR TASK 8, SHOULD NOT WE ALSO WRITE N<=12 && >0 FOR HAS31DAYS VARIABLE? SO THAT
 IT CAN GIVE ERROR WHEN IT IS LESS THAN 0
 */